...
if pestañas == "Modelos con una variable":
       ...
       figur = plt.figure(figsize=(35, 10), dpi=200)
       plt.rc('font', size=12)  # Ajusta el tamaño de fuente aquí
       plot_tree(modelo_musculo_dt_simplified, filled=True, feature_names=X.columns, fontsize=15)  # Ajusta el tamaño de la letra aquí
