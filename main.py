...
if pestañas == "Modelos con una variable":
       ...
       figur = plt.figure(figsize=(50, 20), dpi=600)
       plt.rc('font', size=12)  # Ajusta el tamaño de fuente aquí
       plot_tree(modelo_musculo_dt_simplified, filled=True, feature_names=X.columns, fontsize=18)  # Ajusta el tamaño de la letra aquí
